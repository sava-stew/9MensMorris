...
class SetUp():
    ...
    twelveMensPlacements = {
        'g1': ['open', 'noMill', 20, 20, "g1", ["g4","d1","f2","e3"]],
        'g4': ['open', 'noMill', 245, 20, "g4", ["g1","g7","f4"]],
        'g7': ['open', 'noMill', 480, 20, "g7", ["g4","d4","f6","e5"]],
        'f2': ['open', 'noMill', 105, 90, "f2", ["f4","d2"]],
        'f4': ['open', 'noMill', 245, 90, "f4", ["f2","g4","f6","e4"]],
        'f6': ['open', 'noMill', 385, 90, "f6", ["f4","d6"]],
        'e3': ['open', 'noMill', 175, 160, "e3", ["e4","d3"]],
    ...
    def setUpWindow(self):
        ...
        gameType = tk.Label(window, text='Please select which game you would like to play')
        gameType.grid(column=1, row=0)
